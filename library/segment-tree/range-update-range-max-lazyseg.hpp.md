...
# :heavy_check_mark: segment-tree/range-update-range-max-lazyseg.hpp
...
onlinejudge_verify.languages.cplusplus_bundle.BundleErrorAt: segment-tree/range-update-range-max-lazyseg.hpp: line 3: unable to process #include in #if / #ifdef / #ifndef other than include guards
