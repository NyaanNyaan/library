...
data:
  ...
  bundledCode: "#line 2 \"string/rolling-hash.hpp\"\n#include <bits/stdc++.h>\nusing\
    ...
    \ inline constexpr u64 modmul(const u64 &a, const u64 &b) {\n    u128 ret = u128(a)\
    \ * b;\n    ret = (ret & md) + (ret >> 61);\n    return ret >= md ? ret - md :\
    \ ret;\n  }\n  static inline constexpr u64 modfma(const u64 &a, const u64 &b,\
    \ const u64 &c) {\n    u128 ret = u128(a) * b + c;\n    ret = (ret & md) + (ret\
    \ >> 61);\n    return ret >= md ? ret - md : ret;\n  }\n  constexpr static Hash\
