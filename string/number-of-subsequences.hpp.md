...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"string/number-of-subsequences.hpp\"\n\n#line 2 \"hashmap/hashmap-unerasable.hpp\"\
    \n\n#include <cassert>\n#include <chrono>\n#include <functional>\n#include <vector>\n\
    using namespace std;\n\n#line 2 \"internal/internal-hash-function.hpp\"\n\n#line\
    \ 4 \"internal/internal-hash-function.hpp\"\nusing namespace std;\n\n#line 2 \"\
  ...
  code: "#pragma once\n\n#include \"../hashmap/hashmap-unerasable.hpp\"\n\ntemplate\
    \ <typename Container, typename mint>\nmint number_of_subsequences(const Container&\
    \ S) {\n  using Key = typename Container::value_type;\n  UnerasableHashMap<Key,\
    \ mint> mp;\n  mint al = 1;\n  for (auto& c : S) {\n    mint& mpc = mp[c];\n \
    \   mint x = mpc;\n    mpc = al;\n    al += al - x;\n  }\n  return al - 1;\n}\n"
  dependsOn:
...
documentation_of: string/number-of-subsequences.hpp
layout: document
redirect_from:
- /library/string/number-of-subsequences.hpp
- /library/string/number-of-subsequences.hpp.html
