...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"segment-tree/range-add-range-min-lazyseg.hpp\"\n#include\
    \ <bits/stdc++.h>\nusing namespace std;\n\ntemplate <typename E, E INF>\nstruct\
    \ AddMin_LazySegmentTree {\n  int n, height;\n  using T = E;\n  T f(T a, T b)\
...
documentation_of: segment-tree/range-add-range-min-lazyseg.hpp
layout: document
redirect_from:
- /library/segment-tree/range-add-range-min-lazyseg.hpp
- /library/segment-tree/range-add-range-min-lazyseg.hpp.html
