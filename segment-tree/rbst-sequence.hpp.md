...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"segment-tree/rbst-sequence.hpp\"\n\n#include <vector>\n\
...
documentation_of: segment-tree/rbst-sequence.hpp
layout: document
redirect_from:
- /library/segment-tree/rbst-sequence.hpp
- /library/segment-tree/rbst-sequence.hpp.html
