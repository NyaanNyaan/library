...
data:
  ...
  attributes:
    document_title: Number Theory Transform (for c++11)
    links: []
  bundledCode: "#line 2 \"ntt/ntt-cpp11.hpp\"\n\ntemplate <typename mint>\nstruct\
    ...
    \ back_inserter(a));\n  }\n};\n\n/**\n * @brief Number Theory Transform (for c++11)\n\
    \ */\n"
  code: "#pragma once\n\ntemplate <typename mint>\nstruct NTT {\n  static constexpr\
  ...
  verifiedWith: []
documentation_of: ntt/ntt-cpp11.hpp
layout: document
redirect_from:
- /library/ntt/ntt-cpp11.hpp
- /library/ntt/ntt-cpp11.hpp.html
