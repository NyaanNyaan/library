...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-aoj-ntl/aoj-ntl-1-c.test.cpp\"\n#define PROBLEM\
    \ \\\n  \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_1_C\"\n\
    ...
    \ 2 \"math/elementary-function.hpp\"\n\nlong long my_gcd(long long x, long long\
    \ y) {\n  long long z;\n  if (x > y) swap(x, y);\n  while (x) {\n    x = y % (z\
    \ = x);\n    y = z;\n  }\n  return y;\n}\nlong long my_lcm(long long x, long long\
    ...
    \ = 0;\n  while (n) {\n    n /= 10;\n    ret++;\n  }\n  return ret;\n}\n#line\
    \ 6 \"verify/verify-aoj-ntl/aoj-ntl-1-c.test.cpp\"\n\nusing namespace Nyaan; void\
    \ Nyaan::solve() {\n  ini(N);\n  ll ans = 1;\n  rep(i, N) {\n    ini(n);\n   \
    \ ans = lcm(ans, n);\n  }\n  out(ans);\n}\n"
  code: "#define PROBLEM \\\n  \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_1_C\"\
...
layout: document
redirect_from:
- /verify/verify/verify-aoj-ntl/aoj-ntl-1-c.test.cpp
- /verify/verify/verify-aoj-ntl/aoj-ntl-1-c.test.cpp.html
