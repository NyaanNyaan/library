...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-unit-test/int-div.test.cpp\"\n#define PROBLEM\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-unit-test/int-div.test.cpp\"\
    \n//\n#line 2 \"misc/int_div.hpp\"\n\n// a/b \u4EE5\u4E0B\u306E\u6700\u5927\u306E\
    \u6574\u6570\nlong long floor(long long a, long long b) {\n  assert(b != 0);\n\
    \  if (b < 0) a = -a, b = -b;\n  return a / b - (a % b < 0);\n}\n// a/b \u672A\
    \u6E80\u306E\u6700\u5927\u306E\u6574\u6570\nlong long under(long long a, long\
    \ long b) {\n  assert(b != 0);\n  if (b < 0) a = -a, b = -b;\n  return a / b -\
    \ (a % b <= 0);\n}\n// a/b \u4EE5\u4E0A\u306E\u6700\u5C0F\u306E\u6574\u6570\n\
...
layout: document
redirect_from:
- /verify/verify/verify-unit-test/int-div.test.cpp
- /verify/verify/verify-unit-test/int-div.test.cpp.html
