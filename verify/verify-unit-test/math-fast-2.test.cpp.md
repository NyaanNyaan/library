...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-unit-test/math-fast-2.test.cpp\"\n#define\
    ...
    \ 4 \"verify/verify-unit-test/math-fast-2.test.cpp\"\n//\n#line 2 \"math-fast/gcd.hpp\"\
    ...
    \ * @brief binary GCD\n */\n#line 6 \"verify/verify-unit-test/math-fast-2.test.cpp\"\
    \n\nusing namespace Nyaan;\n\ni128 naive_gcd(i128 a, i128 b) {\n  if (a < 0) a\
    \ = -a;\n  if (b < 0) b = -b;\n  while (b) swap(a %= b, b);\n  return a;\n}\n\n\
    ll x_;\nvoid rng_init() { x_ = 88172645463325252ULL; }\ni128 rng() {\n  ll a =\
    \ (x_ = x_ ^ (x_ << 7), x_ = x_ ^ (x_ >> 9));\n  ll b = (x_ = x_ ^ (x_ << 7),\
    \ x_ = x_ ^ (x_ >> 9));\n  return (i128(a) << 64) + b;\n}\n\nvoid unit_test()\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include \"\
    ...
    \  if (b < 0) b = -b;\n  while (b) swap(a %= b, b);\n  return a;\n}\n\nll x_;\n\
    void rng_init() { x_ = 88172645463325252ULL; }\ni128 rng() {\n  ll a = (x_ = x_\
    \ ^ (x_ << 7), x_ = x_ ^ (x_ >> 9));\n  ll b = (x_ = x_ ^ (x_ << 7), x_ = x_ ^\
    \ (x_ >> 9));\n  return (i128(a) << 64) + b;\n}\n\nvoid unit_test() {\n  using\
    \ P = pair<i128, i128>;\n  using F = i128 (*)(i128, i128);\n\n  vector<P> testcase{P(2,\
    \ 4),\n                     P(100000, 10000),\n                     P(998244353,\
    \ 1000000007),\n                     P(1LL << 40, 1LL << 60),\n              \
    \       P((1LL << 61) - 1, 11111111111111111),\n                     P((1LL <<\
    \ 60) + 1, (1LL << 59) + 1),\n                     P(1LL << 62, 1LL << 62),\n\
    ...
    \     P(0, 0),\n                     P(0, -1),\n                     P(-1, 0),\n\
    \                     P(-1, -1)};\n  for (i128 i = 1000; i--;)\n    for (i128\
    \ j = 1000; j--;) testcase.emplace_back(i, j);\n  rng_init();\n  for (i128 n =\
    \ 10000; n--;) {\n    i128 i = rng(), j = rng();\n    testcase.emplace_back(i,\
    \ j);\n  }\n\n  vector<F> functions{naive_gcd, binary_gcd128};\n\n  for (auto\
    \ p : testcase) {\n    set<i128> s;\n    for (auto &f : functions) {\n      i128\
    \ x = f(p.first, p.second);\n      if (x < 0) x = -x;\n      s.insert(x);\n  \
  ...
  verifiedWith: []
documentation_of: verify/verify-unit-test/math-fast-2.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-unit-test/math-fast-2.test.cpp
- /verify/verify/verify-unit-test/math-fast-2.test.cpp.html
