...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-unit-test/fast-inv-o1.test.cpp\"\n#define\
    ...
    \ 4 \"verify/verify-unit-test/fast-inv-o1.test.cpp\"\n//\n#line 2 \"misc/all.hpp\"\
    ...
    \  long long operator()() { return elapsed(); }\n};\n#line 6 \"verify/verify-unit-test/fast-inv-o1.test.cpp\"\
    ...
    \  }\n  int operator()(int a) { return inv(a); }\n};\n#line 2 \"math-fast/inv.hpp\"\
    \n\n#line 4 \"math-fast/inv.hpp\"\nusing namespace std;\n\n// \u5F15\u6570\u304C\
    \ [0, mod) \u306E\u7BC4\u56F2\u5185, \u304B\u3064\u9006\u5143\u304C\u5B58\u5728\
    \u3059\u308B\u3068\u304D\u306B\u6B63\u3057\u304F\u52D5\u304F\ntemplate <int MOD>\n\
    ...
    \ { return mod; }\n};\n#line 11 \"verify/verify-unit-test/fast-inv-o1.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2023-12-22 20:10:51+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/verify-unit-test/fast-inv-o1.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-unit-test/fast-inv-o1.test.cpp
- /verify/verify/verify-unit-test/fast-inv-o1.test.cpp.html
