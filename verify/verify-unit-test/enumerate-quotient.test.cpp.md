...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-unit-test/enumerate-quotient.test.cpp\"\n\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-unit-test/enumerate-quotient.test.cpp\"\
    ...
    \    R.push_back(r);\n  });\n  V<vl> qlr{Q, L, R};\n  assert(qlr == naive(N));\n\
    }\n\nvoid Nyaan::solve() {\n  rep(i, 10000) test(i);\n  rep(_, 10000) test(randint(TEN(4),\
...
layout: document
redirect_from:
- /verify/verify/verify-unit-test/enumerate-quotient.test.cpp
- /verify/verify/verify-unit-test/enumerate-quotient.test.cpp.html
