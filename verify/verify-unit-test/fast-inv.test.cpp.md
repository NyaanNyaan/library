...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-unit-test/fast-inv.test.cpp\"\n#define PROBLEM\
...
layout: document
redirect_from:
- /verify/verify/verify-unit-test/fast-inv.test.cpp
- /verify/verify/verify-unit-test/fast-inv.test.cpp.html
