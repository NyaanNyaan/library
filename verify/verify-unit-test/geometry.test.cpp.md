...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-unit-test/geometry.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-unit-test/geometry.test.cpp\"\n//\n#line 2 \"geometry/geometry-base.hpp\"\
    ...
    \u7DDA\n  return 0;                                         // a-c-b \u306E\u9806\
    \u3067\u4E00\u76F4\u7DDA\n}\n#line 6 \"verify/verify-unit-test/geometry.test.cpp\"\
    \n\nvoid test() {\n  const Point a{1, 2};\n  assert(a.x == 1.0 and a.y == 2.0);\n\
    \  assert(Point().x == 0.0);\n  assert(Point().y == 0.0);\n  assert(Point(make_pair(1,\
    \ 2)) == a);\n\n  const Point b{3, 4};\n  {\n    Point c = a + b;\n    assert(c.x\
    \ == 4.0 and c.y == 6.0);\n    Point d = a;\n    d += b;\n    assert(c == d);\n\
  ...
  verifiedWith: []
documentation_of: verify/verify-unit-test/geometry.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-unit-test/geometry.test.cpp
- /verify/verify/verify-unit-test/geometry.test.cpp.html
