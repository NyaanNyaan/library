...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-unit-test/fps-sparse.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-unit-test/fps-sparse.test.cpp\"\n//\n#line 2 \"fps/sparse-fps.hpp\"\
    \n\n#line 5 \"fps/sparse-fps.hpp\"\nusing namespace std;\n\n#line 2 \"fps/formal-power-series.hpp\"\
    ...
    \n */\n#line 6 \"verify/verify-unit-test/fps-sparse.test.cpp\"\n//\n#line 2 \"\
    ...
    using my_rand::rnd;\nusing my_rand::rng;\n#line 8 \"verify/verify-unit-test/fps-sparse.test.cpp\"\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 12 \"verify/verify-unit-test/fps-sparse.test.cpp\"\
    ...
    \ (ll k : vector<ll>{0, rng(1, TEN(18))}) {\n        fps g = sparse_pow(f, k,\
    \ deg);\n        fps h = f.pow(k, deg);\n        assert(sz(g) == deg);\n     \
    \   assert(g == h and \"pow\");\n      }\n    }\n  }\n\n  cerr << \"OK\" << endl;\n\
    \  {\n    int a, b;\n    cin >> a >> b;\n    cout << a + b << endl;\n  }\n}\n\n\
    void Nyaan::solve() {\n  int t = 1;\n  // in(t);\n  while (t--) q();\n}\n"
  ...
  requiredBy: []
  timestamp: '2023-08-31 21:22:12+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/verify-unit-test/fps-sparse.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-unit-test/fps-sparse.test.cpp
- /verify/verify/verify-unit-test/fps-sparse.test.cpp.html
