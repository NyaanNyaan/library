...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-unit-test/fast-bs.test.cpp\"\n#define PROBLEM\
    ...
    };\n#line 8 \"verify/verify-unit-test/fast-bs.test.cpp\"\nusing namespace Nyaan;\n\
    ...
    \n  Timer timer;\n\n  timer.reset();\n  ll s1 = 0, t1 = 0;\n  rep(_, loop) s1\
    \ += lb<int>(v, rng(-upper, upper));\n  t1 = timer.elapsed();\n\n  timer.reset();\n\
    \  ll s2 = 0, t2 = 0;\n  rep(_, loop) s2 += fast_lb<int>(v, rng(-upper, upper));\n\
    \  t2 = timer.elapsed();\n\n  timer.reset();\n  ll s3 = 0, t3 = 0;\n  rep(_, loop)\
    \ s3 += fast_ub<int>(v, rng(-upper, upper));\n  t3 = timer.elapsed();\n\n  trc2(N,\
    \ s1, s2, s3, t1, t2, t3);\n}\n\nvoid q() {\n  for (int N : vector{0, 1, 2, 10,\
    \ 100, 1000}) {\n    test<int>(N, 0);\n    test<ll>(N, 0);\n    rep(b, 30) test<int>(N,\
  ...
  verifiedWith: []
documentation_of: verify/verify-unit-test/fast-bs.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-unit-test/fast-bs.test.cpp
- /verify/verify/verify-unit-test/fast-bs.test.cpp.html
