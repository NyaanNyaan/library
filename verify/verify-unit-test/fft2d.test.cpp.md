...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-unit-test/fft2d.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-unit-test/fft2d.test.cpp\"\n//\n#line 2 \"fps/fft2d.hpp\"\n\
    \n#line 5 \"fps/fft2d.hpp\"\nusing namespace std;\n\n#line 2 \"fps/formal-power-series.hpp\"\
    ...
    using my_rand::rnd;\nusing my_rand::rng;\n#line 7 \"verify/verify-unit-test/fft2d.test.cpp\"\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 11 \"verify/verify-unit-test/fft2d.test.cpp\"\
    ...
    \ v) x = rng();\n    auto c1 = multiply2d_naive(a, b);\n    auto c2 = multiply2d_partially_naive(a,\
  ...
  verifiedWith: []
documentation_of: verify/verify-unit-test/fft2d.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-unit-test/fft2d.test.cpp
- /verify/verify/verify-unit-test/fft2d.test.cpp.html
