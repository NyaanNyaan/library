...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-other/yosupo-a-plus-b-128bit.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-other/yosupo-a-plus-b-128bit.test.cpp\"\n//\nusing\
    \ namespace Nyaan;\n\nvoid q() {\n  i128 a, b;\n  in(a, b);\n  out(a + b);\n}\n\
    \nvoid Nyaan::solve() {\n  int t = 1;\n  in(t);\n  while (t--) q();\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-other/yosupo-a-plus-b-128bit.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-other/yosupo-a-plus-b-128bit.test.cpp
- /verify/verify/verify-yosupo-other/yosupo-a-plus-b-128bit.test.cpp.html
