...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-other/yosupo-static-convex-hull-2.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-other/yosupo-static-convex-hull-2.test.cpp\"\n//\n\
    ...
    \  Point operator-(const Point &p) const { return Point(*this) -= p; }\n  Point\
    \ operator-() const { return Point(-this->x, -this->y); }\n  bool operator==(const\
    ...
    \ <= 0) --k;\n  }\n  convex.resize(k - 1);\n  return convex;\n}\n#line 6 \"verify/verify-yosupo-other/yosupo-static-convex-hull-2.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-other/yosupo-static-convex-hull-2.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-other/yosupo-static-convex-hull-2.test.cpp
- /verify/verify/verify-yosupo-other/yosupo-static-convex-hull-2.test.cpp.html
