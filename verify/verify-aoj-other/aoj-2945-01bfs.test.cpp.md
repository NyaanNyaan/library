...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-aoj-other/aoj-2945-01bfs.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2945\"\n\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-aoj-other/aoj-2945-01bfs.test.cpp\"\
    ...
    \      } else {\n        Q.push_back(dst);\n      }\n    }\n  }\n  return d;\n\
    }\n#line 6 \"verify/verify-aoj-other/aoj-2945-01bfs.test.cpp\"\n//\nusing namespace\
    \ Nyaan;\nvoid Nyaan::solve() {\n  WeightedGraph<int> g(10000);\n  auto ok = [](int\
    \ i) { return 0 <= i and i < 100; };\n  auto id = [](int i, int j) { return i\
    \ * 100 + j; };\n  while (1) {\n    int n;\n    in(n);\n    if (!n) break;\n \
    \   int a, b, c, d;\n    in(a, b, c, d);\n    --a, --b, --c, --d;\n    g.clear();\n\
    \    g.resize(10000);\n    rep(i, 100) rep(j, 100) {\n      int e;\n      if (a\
    \ <= i and i <= c and b <= j and j <= d) {\n        e = 0;\n      } else {\n \
    \       e = 1;\n      }\n      int x = 1, y = 0;\n      rep(_, 4) {\n        int\
    \ nx = i + x;\n        int ny = j + y;\n        if (ok(nx) and ok(ny)) {\n   \
  ...
  verifiedWith: []
documentation_of: verify/verify-aoj-other/aoj-2945-01bfs.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-aoj-other/aoj-2945-01bfs.test.cpp
- /verify/verify/verify-aoj-other/aoj-2945-01bfs.test.cpp.html
