...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-aoj-other/aoj-3086.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3086\"\n//\n#line\
    ...
    \ 4 \"verify/verify-aoj-other/aoj-3086.test.cpp\"\n//\n#line 2 \"dp/monge-shortest-path.hpp\"\
    ...
    \ 6 \"verify/verify-aoj-other/aoj-3086.test.cpp\"\n//\n#line 2 \"segment-tree/segment-tree.hpp\"\
    ...
    \ {\n            sm = f(seg[r], sm);\n            r--;\n          }\n        }\n\
    \        return r + 1 - size;\n      }\n      sm = f(seg[r], sm);\n    } while\
    \ ((r & -r) != r);\n    return 0;\n  }\n};\n#line 8 \"verify/verify-aoj-other/aoj-3086.test.cpp\"\
    \nusing namespace Nyaan;\n\nvoid q() {\n  inl(N, L);\n  vl d(N);\n  in(d);\n \
    \ each(x, d) x = -x;\n  SegmentTree seg(\n      d, [](ll a, ll b) { return min(a,\
    \ b); }, infLL);\n  auto ans = monge_shortest_path<ll>(N, [&](int l, int r) ->\
  ...
  verifiedWith: []
documentation_of: verify/verify-aoj-other/aoj-3086.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-aoj-other/aoj-3086.test.cpp
- /verify/verify/verify-aoj-other/aoj-3086.test.cpp.html
