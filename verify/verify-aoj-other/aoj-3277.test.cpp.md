...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-aoj-other/aoj-3277.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3277\"\n\n#line\
    ...
    \ 4 \"verify/verify-aoj-other/aoj-3277.test.cpp\"\n//\n#line 2 \"math/sweep.hpp\"\
    \n\n#line 5 \"math/sweep.hpp\"\nusing namespace std;\n\n// MAX bit\ntemplate <typename\
    \ Int, int MAX>\nstruct Basis {\n  array<Int, MAX> v;\n\n  Basis() : _size(0)\
    \ { fill(begin(v), end(v), Int{0}); }\n  Basis(const vector<Int>& a) : _size(0)\
    \ {\n    fill(begin(v), end(v), Int{0});\n    for (auto& x : a) add(x);\n  }\n\
    \  const Int operator[](int i) const { return v[i]; }\n\n  // \u8FFD\u52A0\u6210\
    \u529F\u304B\u3069\u3046\u304B\u3092\u8FD4\u3059\n  bool add(Int x) {\n    int\
    \ t = _msb(x);\n    assert(t < MAX);\n    while (t != -1 && v[t]) t = _msb(x ^=\
  ...
  verifiedWith: []
documentation_of: verify/verify-aoj-other/aoj-3277.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-aoj-other/aoj-3277.test.cpp
- /verify/verify/verify-aoj-other/aoj-3277.test.cpp.html
