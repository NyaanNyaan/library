...
# :heavy_check_mark: verify/verify-yosupo-graph/yosupo-strongly-connected-components.test.cpp
...
* <a href="{{ site.github.repository_url }}/blob/master/verify/verify-yosupo-graph/yosupo-strongly-connected-components.test.cpp">View this file on GitHub</a>
    - Last commit date: 2020-08-02 19:53:18+09:00
...
{% raw %}
```cpp
#line 1 "verify/verify-yosupo-graph/yosupo-strongly-connected-components.test.cpp"
#define PROBLEM "https://judge.yosupo.jp/problem/scc"
