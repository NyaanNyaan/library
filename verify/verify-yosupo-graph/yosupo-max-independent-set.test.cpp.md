...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-graph/yosupo-max-independent-set.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/maximum_independent_set\"\
    ...
    \ M;\n  rd(N, M);\n  vector<vector<int>> g(N);\n  rep(i, M) {\n    int u, v;\n\
    \    rd(u, v);\n    g[u].push_back(v);\n    g[v].push_back(u);\n  }\n  auto ans\
    \ = max_independent_set<40>(g);\n  wtn(ans.size());\n  rep(i, ans.size()) wt(ans[i],\
    \ (i == (int)ans.size() - 1 ? '\\n' : ' '));\n}"
  dependsOn:
...
layout: document
redirect_from:
- /verify/verify/verify-yosupo-graph/yosupo-max-independent-set.test.cpp
- /verify/verify/verify-yosupo-graph/yosupo-max-independent-set.test.cpp.html
