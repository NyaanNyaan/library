...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-graph/yosupo-diameter.test.cpp\"\n\
    ...
    \ 5 \"verify/verify-yosupo-graph/yosupo-diameter.test.cpp\"\n\nusing namespace\
...
layout: document
redirect_from:
- /verify/verify/verify-yosupo-graph/yosupo-diameter.test.cpp
- /verify/verify/verify-yosupo-graph/yosupo-diameter.test.cpp.html
