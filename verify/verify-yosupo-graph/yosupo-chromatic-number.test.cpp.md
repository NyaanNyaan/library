...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-graph/yosupo-chromatic-number.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-graph/yosupo-chromatic-number.test.cpp\"\n//\n#line\
    \ 2 \"graph/chromatic-number.hpp\"\n\n#line 6 \"graph/chromatic-number.hpp\"\n\
    ...
    \ d;\n}\n#line 7 \"verify/verify-yosupo-graph/yosupo-chromatic-number.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2021-03-04 10:48:44+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/verify-yosupo-graph/yosupo-chromatic-number.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-graph/yosupo-chromatic-number.test.cpp
- /verify/verify/verify-yosupo-graph/yosupo-chromatic-number.test.cpp.html
