...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-math/yosupo-pow-of-matrix.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-math/yosupo-pow-of-matrix.test.cpp\"\n//\n#line 2 \"\
    ...
    \ = i; k < W(); k++) {\n          B[j][k] -= B[i][k] * a;\n        }\n      }\n\
    \    }\n    return ret;\n  }\n};\n\n/**\n * @brief \u884C\u5217\u30E9\u30A4\u30D6\
    \u30E9\u30EA\n */\n#line 6 \"verify/verify-yosupo-math/yosupo-pow-of-matrix.test.cpp\"\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 9 \"verify/verify-yosupo-math/yosupo-pow-of-matrix.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-math/yosupo-pow-of-matrix.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-math/yosupo-pow-of-matrix.test.cpp
- /verify/verify/verify-yosupo-math/yosupo-pow-of-matrix.test.cpp.html
