...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-math/yosupo-counting-primes-4.test.cpp\"\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yosupo-math/yosupo-counting-primes-4.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/verify-yosupo-math/yosupo-counting-primes-4.test.cpp
- /verify/verify/verify-yosupo-math/yosupo-counting-primes-4.test.cpp.html
