...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-math/yosupo-two-square-sum.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-math/yosupo-two-square-sum.test.cpp\"\n//\n#line 2\
    ...
    \ g.x);\n  }\n  sort(begin(ans), end(ans));\n  return ans;\n}\n#line 6 \"verify/verify-yosupo-math/yosupo-two-square-sum.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-math/yosupo-two-square-sum.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-math/yosupo-two-square-sum.test.cpp
- /verify/verify/verify-yosupo-math/yosupo-two-square-sum.test.cpp.html
