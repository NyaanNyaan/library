...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-math/yosupo-characteristic-polynomial.test.cpp\"\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yosupo-math/yosupo-characteristic-polynomial.test.cpp\"\
    ...
    \ += coe * p[i - m - 1][j];\n    }\n  }\n  return p[N];\n}\n#line 6 \"verify/verify-yosupo-math/yosupo-characteristic-polynomial.test.cpp\"\
    ...
    \ { return mod; }\n};\n#line 8 \"verify/verify-yosupo-math/yosupo-characteristic-polynomial.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-math/yosupo-characteristic-polynomial.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-math/yosupo-characteristic-polynomial.test.cpp
- /verify/verify/verify-yosupo-math/yosupo-characteristic-polynomial.test.cpp.html
