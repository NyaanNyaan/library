...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-math/yosupo-rational-approximation.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-math/yosupo-rational-approximation.test.cpp\"\n//\n\
    ...
    \ m.get().second) > INF)\n        return {m.lower_bound(), m.upper_bound()};\n\
    \    }\n  }\n}\n#line 6 \"verify/verify-yosupo-math/yosupo-rational-approximation.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-math/yosupo-rational-approximation.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-math/yosupo-rational-approximation.test.cpp
- /verify/verify/verify-yosupo-math/yosupo-rational-approximation.test.cpp.html
