...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-math/yosupo-sum-of-floor.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/verify-yosupo-math/yosupo-sum-of-floor.test.cpp
- /verify/verify/verify-yosupo-math/yosupo-sum-of-floor.test.cpp.html
