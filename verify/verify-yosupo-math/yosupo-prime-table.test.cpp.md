...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-math/yosupo-prime-table.test.cpp\"\n\
...
layout: document
redirect_from:
- /verify/verify/verify-yosupo-math/yosupo-prime-table.test.cpp
- /verify/verify/verify-yosupo-math/yosupo-prime-table.test.cpp.html
