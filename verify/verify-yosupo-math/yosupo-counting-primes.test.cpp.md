...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-math/yosupo-counting-primes.test.cpp\"\
    ...
    \ 2 \"multiplicative-function/prime-counting.hpp\"\n\n\n\npair<vector<long long>,\
    \ vector<long long>> pi_table(long long N) {\n  using i64 = long long;\n  vector<i64>\
...
layout: document
redirect_from:
- /verify/verify/verify-yosupo-math/yosupo-counting-primes.test.cpp
- /verify/verify/verify-yosupo-math/yosupo-counting-primes.test.cpp.html
