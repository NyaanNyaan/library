...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-math/yosupo-concave-min-plus-convolution-1.test.cpp\"\
    ...
    using my_rand::rnd;\nusing my_rand::rng;\n#line 6 \"verify/verify-yosupo-math/yosupo-concave-min-plus-convolution-1.test.cpp\"\
    ...
    \    ans[i] = a[i - j] + b[j];\n  }\n  return ans;\n}\n#line 8 \"verify/verify-yosupo-math/yosupo-concave-min-plus-convolution-1.test.cpp\"\
