...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-ds/yosupo-static-rmq.test.cpp\"\n#define\
    ...
    \ table[b][r - (1 << b)]);\n  }\n};\n\n/**\n * @brief Sparse Table\n */\n#line\
    \ 5 \"verify/verify-yosupo-ds/yosupo-static-rmq.test.cpp\"\n\nusing namespace\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-ds/yosupo-static-rmq.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-ds/yosupo-static-rmq.test.cpp
- /verify/verify/verify-yosupo-ds/yosupo-static-rmq.test.cpp.html
