...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-ds/yosupo-point-add-range-sum.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/verify-yosupo-ds/yosupo-point-add-range-sum.test.cpp
- /verify/verify/verify-yosupo-ds/yosupo-point-add-range-sum.test.cpp.html
