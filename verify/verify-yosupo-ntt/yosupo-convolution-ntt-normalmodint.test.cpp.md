...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-ntt/yosupo-convolution-ntt-normalmodint.test.cpp\"\
    ...
    \      for (int j = 0; j < u; ++j) {\n        mint ajv = a[j] - a[j + u];\n  \
    \      a[j] += a[j + u];\n        a[j + u] = ajv;\n      }\n    }\n  }\n\n  void\
    \ ntt(vector<mint> &a) { fft4(a, __builtin_ctz(a.size())); }\n\n  void intt(vector<mint>\
    \ &a) { ifft4(a, __builtin_ctz(a.size())); }\n\n  vector<mint> multiply(const\
    ...
    \    return s;\n  }\n};\n#line 6 \"verify/verify-yosupo-ntt/yosupo-convolution-ntt-normalmodint.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/verify-yosupo-ntt/yosupo-convolution-ntt-normalmodint.test.cpp
- /verify/verify/verify-yosupo-ntt/yosupo-convolution-ntt-normalmodint.test.cpp.html
