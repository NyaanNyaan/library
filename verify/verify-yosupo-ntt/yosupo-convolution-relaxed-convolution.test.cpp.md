...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-ntt/yosupo-convolution-relaxed-convolution.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-ntt/yosupo-convolution-relaxed-convolution.test.cpp\"\
    ...
    using fastio::wtn;\n#line 6 \"verify/verify-yosupo-ntt/yosupo-convolution-relaxed-convolution.test.cpp\"\
    \n//\n#line 2 \"ntt/relaxed-convolution.hpp\"\n\n#line 5 \"ntt/relaxed-convolution.hpp\"\
    \nusing namespace std;\n\n// x^0, x^1, ..., x^N \u3092\u30AA\u30F3\u30E9\u30A4\
    \u30F3\u3067\u8A08\u7B97\u3059\u308B\ntemplate <typename fps>\nstruct RelaxedConvolution\
    \ {\n  using mint = typename fps::value_type;\n  int N, q;\n  vector<mint> a,\
    \ b, c;\n  fps f, g;\n  vector<fps> as, bs;\n\n  RelaxedConvolution(int _n) :\
    ...
    \       f.intt();\n        for (int i = q; i < min(q + d, N + 1); i++) c[i] +=\
    \ f[d + i - q];\n      }\n    }\n    return c[q - 1];\n  }\n};\n\n/**\n * @brief\
    \ Relaxed Convolution\n */\n#line 8 \"verify/verify-yosupo-ntt/yosupo-convolution-relaxed-convolution.test.cpp\"\
    ...
    \ { return mod; }\n};\n#line 11 \"verify/verify-yosupo-ntt/yosupo-convolution-relaxed-convolution.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-ntt/yosupo-convolution-relaxed-convolution.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-ntt/yosupo-convolution-relaxed-convolution.test.cpp
- /verify/verify/verify-yosupo-ntt/yosupo-convolution-relaxed-convolution.test.cpp.html
