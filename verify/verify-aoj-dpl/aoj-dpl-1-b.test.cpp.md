...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-aoj-dpl/aoj-dpl-1-b.test.cpp\"\n\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_1_B\"\
    ...
    \ 5 \"verify/verify-aoj-dpl/aoj-dpl-1-b.test.cpp\"\n//\n#line 2 \"dp/knapsack01.hpp\"\
    \n\nlong long knapsack01(const vector<long long>& v, const vector<long long>&\
    \ w,\n                     long long W) {\n  double v_sum = 0;\n  for (auto& x\
    ...
    \  }\n  return ans;\n}\n#line 7 \"verify/verify-aoj-dpl/aoj-dpl-1-b.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-aoj-dpl/aoj-dpl-1-b.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-aoj-dpl/aoj-dpl-1-b.test.cpp
- /verify/verify/verify-aoj-dpl/aoj-dpl-1-b.test.cpp.html
