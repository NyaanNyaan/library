...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-string/yosupo-number-of-subsequences.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-string/yosupo-number-of-subsequences.test.cpp\"\n//\n\
    ...
    \ Container, typename mint>\nmint number_of_subsequences(const Container& S) {\n\
    \  using Key = typename Container::value_type;\n  UnerasableHashMap<Key, mint>\
    \ mp;\n  mint al = 1;\n  for (auto& c : S) {\n    mint& mpc = mp[c];\n    mint\
    \ x = mpc;\n    mpc = al;\n    al += al - x;\n  }\n  return al - 1;\n}\n#line\
    \ 6 \"verify/verify-yosupo-string/yosupo-number-of-subsequences.test.cpp\"\n//\n\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 9 \"verify/verify-yosupo-string/yosupo-number-of-subsequences.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-string/yosupo-number-of-subsequences.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-string/yosupo-number-of-subsequences.test.cpp
- /verify/verify/verify-yosupo-string/yosupo-number-of-subsequences.test.cpp.html
