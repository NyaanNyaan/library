...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-string/yosupo-run-enumerate.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-string/yosupo-run-enumerate.test.cpp\"\n//\n#line 2\
    \ \"string/run-enumerate.hpp\"\n\n#line 7 \"string/run-enumerate.hpp\"\nusing\
    ...
    \      if (!done.count(lr)) {\n        done.insert(lr);\n        res.emplace_back(p,\
    \ lr.first, lr.second);\n      }\n    }\n  }\n  return res;\n}\n#line 6 \"verify/verify-yosupo-string/yosupo-run-enumerate.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-string/yosupo-run-enumerate.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-string/yosupo-run-enumerate.test.cpp
- /verify/verify/verify-yosupo-string/yosupo-run-enumerate.test.cpp.html
