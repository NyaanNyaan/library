...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-string/yosupo-z-algorithm.test.cpp\"\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yosupo-string/yosupo-z-algorithm.test.cpp\"\
    \n//\n#line 2 \"string/z-algorithm.hpp\"\n\ntemplate<typename Container>\nvector<int>\
    \ z_algorithm(Container s) {\n  int n = s.size();\n  vector<int> a(n);\n  a[0]\
    \ = n;\n  int i = 1, j = 0;\n  while (i < n) {\n    while (i + j < n && s[j] ==\
    \ s[i + j]) ++j;\n    a[i] = j;\n    if (j == 0) {\n      ++i;\n      continue;\n\
...
layout: document
redirect_from:
- /verify/verify/verify-yosupo-string/yosupo-z-algorithm.test.cpp
- /verify/verify/verify-yosupo-string/yosupo-z-algorithm.test.cpp.html
