...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-string/yosupo-wildcard-pattern-matching.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-string/yosupo-wildcard-pattern-matching.test.cpp\"\n\
    ...
    \n/**\n * @brief Wildcard Pattern Matching\n */\n#line 6 \"verify/verify-yosupo-string/yosupo-wildcard-pattern-matching.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-string/yosupo-wildcard-pattern-matching.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-string/yosupo-wildcard-pattern-matching.test.cpp
- /verify/verify/verify-yosupo-string/yosupo-wildcard-pattern-matching.test.cpp.html
