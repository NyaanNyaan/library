...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1340-bitmatrix.test.cpp\"\n#define\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yuki/yuki-1340-bitmatrix.test.cpp\"\
    ...
    \ bitset<MAX_W> &operator[](int i) const { return A[i]; }\n  int height() { return\
    \ H; }\n  int size() { return H; }\n  int width() { return W; }\n\n  static BitMatrix\
...
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1340-bitmatrix.test.cpp
- /verify/verify/verify-yuki/yuki-1340-bitmatrix.test.cpp.html
