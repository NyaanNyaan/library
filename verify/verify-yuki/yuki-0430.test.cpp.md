...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-0430.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-yuki/yuki-0430.test.cpp\"\n//\n#line 2 \"string/aho-corasick.hpp\"\
    ...
    \ {\n        res += 1LL * cnt[key] * val;\n      }\n    }\n    return res;\n \
    \ }\n\n  int count(int pos) { return cnt[pos]; }\n};\n#line 6 \"verify/verify-yuki/yuki-0430.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-0430.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-0430.test.cpp
- /verify/verify/verify-yuki/yuki-0430.test.cpp.html
