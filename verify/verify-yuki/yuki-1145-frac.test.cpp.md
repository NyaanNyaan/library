...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1145-frac.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-yuki/yuki-1145-frac.test.cpp\"\n//\n#line 2 \"fps/fps-fraction.hpp\"\
    \n\ntemplate <typename fps>\nstruct fps_fraction {\n  using frac = fps_fraction;\n\
    \  using mint = typename fps::value_type;\n\n  fps p, q;\n  fps_fraction(const\
    \ fps& numerator = fps{0}, const fps& denominator = fps{1})\n      : p(numerator),\
    ...
    \ mint& r) { return frac{*this} -= r; }\n  frac operator*(const mint& r) { return\
    ...
    \ frac& l, const frac& r) {\n    return l.p != r.p || l.q != r.q;\n  }\n  friend\
    \ ostream& operator<<(ostream& os, const frac& r) {\n    os << \"[ \";\n    for\
    \ (auto& x : r.p) os << x << \", \";\n    os << \"], \";\n    os << \"[ \";\n\
    \    for (auto& x : r.q) os << x << \", \";\n    os << \" ]\";\n    return os;\n\
...
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1145-frac.test.cpp
- /verify/verify/verify-yuki/yuki-1145-frac.test.cpp.html
