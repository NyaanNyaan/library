...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-0303.test.cpp\"\n#define PROBLEM\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yuki/yuki-0303.test.cpp\"\
    ...
    \ @brief \u591A\u500D\u9577\u6574\u6570\n */\n#line 6 \"verify/verify-yuki/yuki-0303.test.cpp\"\
    ...
    )\n */\n#line 8 \"verify/verify-yuki/yuki-0303.test.cpp\"\n\nusing namespace Nyaan;\n\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/303\"\n//\n#include \"\
    ...
    \ Mat = Matrix<bigint, 2, 2>;\n\n// a^n\ntemplate <typename T, typename U>\nT\
    \ power(const T& a, U n, const T& I) {\n  assert(n >= 0);\n  if (n == 0) return\
    \ I;\n  T half = power(a, n / 2, I);\n  T res = half * half;\n  return n % 2 ?\
    \ res * a : res;\n}\n\nvoid Nyaan::solve() {\n  int l;\n  cin >> l;\n  if (l ==\
    \ 2) die(\"3\\nINF\");\n  cout << l << endl;\n  Mat A, I;\n  A[0][0] = A[0][1]\
    \ = A[1][0] = 1;\n  I[0][0] = I[1][1] = 1;\n  if (l & 1) {\n    cout << power(A,\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-0303.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-0303.test.cpp
- /verify/verify/verify-yuki/yuki-0303.test.cpp.html
