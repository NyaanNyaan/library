...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-2266.test.cpp\"\n#define PROBLEM\
    ...
    \ ans;\n}\n\n}  // namespace atcoder\n\n\n#line 6 \"verify/verify-yuki/yuki-2266.test.cpp\"\
    ...
    \ -> int { return 1; };\n  enumerate_mf_prefix_sum<int, decltype(sg), decltype(sh)>\
    \ moe(N, sg, sh);\n\n  auto cnt = [&](Rational f) -> ll {\n    ll s = 0;\n   \
    \ enumerate_quotient(N, [&](ll q, ll l, ll r) {\n      ll x = 0;\n      x += atcoder::floor_sum(r\
    \ + 1, f.y, f.x, 0);\n      x -= atcoder::floor_sum(l + 1, f.y, f.x, 0);\n   \
    \   s += x * moe(q);\n    });\n    return s;\n  };\n  auto judge = [&](Rational\
    \ f) -> bool { return cnt(f) >= K; };\n  auto ans = binary_search_on_stern_brocot_tree(judge,\
    \ N);\n  return {ans.x, ans.y};\n}\n\nvoid q() {\n  inl(N, K);\n  auto g = [](ll\
