...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-0720.test.cpp\"\n#define PROBLEM\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yuki/yuki-0720.test.cpp\"\
    ...
    \ Mod-Pow ($f(x)^k \\mod g(x)$)\n */\n#line 8 \"verify/verify-yuki/yuki-0720.test.cpp\"\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 12 \"verify/verify-yuki/yuki-0720.test.cpp\"\
    \nusing mint = LazyMontgomeryModInt<1000000007>;\nBinomial<mint> C;\nusing vm\
    \ = vector<mint>;\nusing vvm = vector<vm>;\nusing fps = FormalPowerSeries<mint>;\n\
    \nvoid Nyaan::solve() {\n  inl(n, m);\n  fps Q{-1, -1, 1};\n  fps f = mod_pow<mint>(m,\
    \ {0, 1}, Q);\n  fps a;\n  ll r = 0;\n  for (int b = msb(n); b >= 0; --b) {\n\
    \    if (b != msb(n)) {\n      fps ad = mod_pow(r, f, Q);\n      a += a * ad %\
    \ Q;\n      r *= 2;\n    }\n    if (gbit(n, b)) a += mod_pow(++r, f, Q);\n  }\n\
    \  a.resize(2);\n  out(a[1]);\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/720\"\n\n#include \"../../template/template.hpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-0720.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-0720.test.cpp
- /verify/verify/verify-yuki/yuki-0720.test.cpp.html
