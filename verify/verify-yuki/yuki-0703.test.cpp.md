...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-0703.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-yuki/yuki-0703.test.cpp\"\n//\n#line 2 \"dp/monge-shortest-path.hpp\"\
    ...
    \ 6 \"verify/verify-yuki/yuki-0703.test.cpp\"\n//\nusing namespace Nyaan;\n\n\
    void q() {\n  inl(N);\n  vl a(N), x(N), y(N);\n  in(a, x, y);\n  // \u4EBA i,\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-0703.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-0703.test.cpp
- /verify/verify/verify-yuki/yuki-0703.test.cpp.html
