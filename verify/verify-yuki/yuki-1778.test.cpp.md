...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1778.test.cpp\"\n#define PROBLEM\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yuki/yuki-1778.test.cpp\"\
    ...
    \ 2 \"tree/inclusion-tree.hpp\"\n\n// [0, N) \u306E\u5305\u542B\u95A2\u4FC2\u306B\
    \u95A2\u3059\u308B\u6728\n//\n// \u5165\u529B : \u533A\u9593[L, R) \u306E\u7D44\
    \ (\u5305\u542B OK, \u4EA4\u5DEE NG)\n// \u51FA\u529B : g : \u30B0\u30E9\u30D5\
    \n//   AB : \u7834\u58CA\u7684, (first, -second) \u306E\u6607\u9806\u3067\u30BD\
    \u30FC\u30C8\u3055\u308C\u308B\n//        & AB[0] \u306B\u8D85\u9802\u70B9 (-1,\
    ...
    \ = AB[p];\n      assert(v <= a);\n      if (b <= pb) break;\n      assert(!(a\
    \ < pb && pb < b));\n      p = par[p];\n    }\n    g[p].push_back(i);\n    par[i]\
    \ = p;\n  }\n  return g;\n}\n#line 7 \"verify/verify-yuki/yuki-1778.test.cpp\"\
    \n//\nusing namespace Nyaan;\n\nvoid Nyaan::solve() {\n  inl(N, Q);\n  ins(S);\n\
    \n  vp vc;\n  vector<int> a(N);\n\n  {\n    vi st;\n    rep(j, N) {\n      if\
    \ (S[j] == ')') {\n        int i = st.back();\n        st.pop_back();\n      \
    \  vc.emplace_back(i, j + 1);\n        a[i] = j, a[j] = i;\n      } else {\n \
    \       st.push_back(j);\n      }\n    }\n  }\n\n  auto g = inclusion_tree(vc,\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-1778.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1778.test.cpp
- /verify/verify/verify-yuki/yuki-1778.test.cpp.html
