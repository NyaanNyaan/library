...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1340-semiring.test.cpp\"\n#define\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yuki/yuki-1340-semiring.test.cpp\"\
    \n//\nusing namespace Nyaan;\n\n#line 2 \"math/semiring.hpp\"\n\ntemplate <typename\
    \ T, T (*add)(T, T), T (*mul)(T, T), T (*I0)(), T (*I1)()>\nstruct semiring {\n\
    \  T x;\n  semiring() : x(I0()) {}\n  semiring(T y) : x(y) {}\n  static T id0()\
...
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1340-semiring.test.cpp
- /verify/verify/verify-yuki/yuki-1340-semiring.test.cpp.html
