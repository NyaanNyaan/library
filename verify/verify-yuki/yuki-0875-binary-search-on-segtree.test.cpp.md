...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-0875-binary-search-on-segtree.test.cpp\"\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yuki/yuki-0875-binary-search-on-segtree.test.cpp\"\
    ...
    \ (check(f(seg[r], sm))) {\n            sm = f(seg[r], sm);\n            r--;\n\
    \          }\n        }\n        return r + 1 - size;\n      }\n      sm = f(seg[r],\
    \ sm);\n    } while ((r & -r) != r);\n    return 0;\n  }\n};\n#line 6 \"verify/verify-yuki/yuki-0875-binary-search-on-segtree.test.cpp\"\
    \n\nusing namespace Nyaan;\nvoid Nyaan::solve() {\n  ini(N, Q);\n  vi a(N);\n\
    \  in(a);\n  auto f = [](int s, int t) { return min(s, t); };\n  SegmentTree<int,\
    \ decltype(f)> seg(a, f, inf);\n  rep(_, Q) {\n    ini(c, l, r);\n    if (c ==\
    \ 1) {\n      l--, r--;\n      int vl = seg[l];\n      seg.update(l, seg[r]);\n\
    \      seg.update(r, vl);\n    } else {\n      l--;\n      int mn = seg.query(l,\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/875\"\n\n#include \"../../template/template.hpp\"\
    ...
    void Nyaan::solve() {\n  ini(N, Q);\n  vi a(N);\n  in(a);\n  auto f = [](int s,\
    \ int t) { return min(s, t); };\n  SegmentTree<int, decltype(f)> seg(a, f, inf);\n\
    \  rep(_, Q) {\n    ini(c, l, r);\n    if (c == 1) {\n      l--, r--;\n      int\
    \ vl = seg[l];\n      seg.update(l, seg[r]);\n      seg.update(r, vl);\n    }\
    \ else {\n      l--;\n      int mn = seg.query(l, r);\n      int a1 = seg.max_right(l,\
    \ [&](int n) { return n > mn; });\n      int a2 = seg.min_left(r, [&](int n) {\
    \ return n > mn; });\n      a2--;\n      assert(a1 == a2);\n      out(a1 + 1);\n\
    \    }\n  }\n}"
  dependsOn:
  - template/template.hpp
...
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-0875-binary-search-on-segtree.test.cpp
- /verify/verify/verify-yuki/yuki-0875-binary-search-on-segtree.test.cpp.html
