...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1939-sparse-pow.test.cpp\"\n#define\
    ...
    \ 4 \"verify/verify-yuki/yuki-1939-sparse-pow.test.cpp\"\n//\n#line 2 \"fps/sparse-fps.hpp\"\
    ...
    \n */\n#line 6 \"verify/verify-yuki/yuki-1939-sparse-pow.test.cpp\"\n//\n#line\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 10 \"verify/verify-yuki/yuki-1939-sparse-pow.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-1939-sparse-pow.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1939-sparse-pow.test.cpp
- /verify/verify/verify-yuki/yuki-1939-sparse-pow.test.cpp.html
