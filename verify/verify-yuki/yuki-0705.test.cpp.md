...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-0705.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-yuki/yuki-0705.test.cpp\"\n//\n#line 2 \"dp/monge-shortest-path.hpp\"\
    ...
    \ 6 \"verify/verify-yuki/yuki-0705.test.cpp\"\n//\nusing namespace Nyaan;\n\n\
    void q() {\n  inl(N);\n  vl a(N), x(N), y(N);\n  in(a, x, y);\n  auto cubic =\
    \ [](ll z) { return abs(z * z * z); };\n  // \u4EBA i, \u30B4\u30DF j\n  auto\
    \ dist = [&](int i, int j) { return cubic(x[j] - a[i]) + cubic(y[j]); };\n  auto\
    \ f = [&](int i, int j) { return dist(j - 1, i); };\n  auto ans = monge_shortest_path<ll>(N,\
    \ f);\n  out(ans[N]);\n}\n\nvoid Nyaan::solve() {\n  int t = 1;\n  // in(t);\n\
    \  while (t--) q();\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/705\"\n//\n#include \"\
    ...
    \ i, \u30B4\u30DF j\n  auto dist = [&](int i, int j) { return cubic(x[j] - a[i])\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-0705.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-0705.test.cpp
- /verify/verify/verify-yuki/yuki-0705.test.cpp.html
