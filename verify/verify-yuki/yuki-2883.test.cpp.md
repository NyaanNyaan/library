...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/2883
    links:
    - https://yukicoder.me/problems/no/2883
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-2883.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-yuki/yuki-2883.test.cpp\"\n//\n#line 2 \"modint/adjunction-modint.hpp\"\
    \n\n// a + b sqrt(B)\ntemplate <typename mint, long long B>\nstruct Adjunction\
    \ {\n  using A = Adjunction;\n  mint a, b;\n  Adjunction(mint _a = 0, mint _b\
    \ = 0) : a(_a), b(_b) {}\n  Adjunction(long long x) : a(x), b(0) {}\n  friend\
    \ A operator+(const A& l, const A& r) { return {l.a + r.a, l.b + r.b}; }\n  friend\
    \ A operator-(const A& l, const A& r) { return {l.a - r.a, l.b - r.b}; }\n  friend\
    \ A operator*(const A& l, const A& r) {\n    return {l.a * r.a + l.b * r.b * B,\
    ...
    \ \" \" << rhs.b;\n  }\n};\n#line 6 \"verify/verify-yuki/yuki-2883.test.cpp\"\n\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 9 \"verify/verify-yuki/yuki-2883.test.cpp\"\
    ...
    \  out(ans.a);\n}\n\nvoid Nyaan::solve() {\n  int t = 1;\n  // in(t);\n  while\
    \ (t--) q();\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2883\"\n//\n#include \"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-2883.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-2883.test.cpp
- /verify/verify/verify-yuki/yuki-2883.test.cpp.html
