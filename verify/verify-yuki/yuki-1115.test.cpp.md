...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1115.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-yuki/yuki-1115.test.cpp\"\n//\n#line 2 \"dp/inversion-counting.hpp\"\
    ...
    }\n#line 6 \"verify/verify-yuki/yuki-1115.test.cpp\"\nusing namespace Nyaan;\n\
    \nvoid q() {\n  inl(N);\n  vl a(N), b(N);\n  in(a, b);\n  out(swap_distance(a,\
    \ b));\n}\n\nvoid Nyaan::solve() {\n  int t = 1;\n  // in(t);\n  while (t--) q();\n\
    }\n"
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-1115.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1115.test.cpp
- /verify/verify/verify-yuki/yuki-1115.test.cpp.html
