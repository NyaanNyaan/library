...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/361
    links:
    - https://yukicoder.me/problems/no/361
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-0361.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-yuki/yuki-0361.test.cpp\"\n//\n#line 2 \"game/impartial-game.hpp\"\
    ...
    \ Nyaan::solve() {\n  int t = 1;\n  // in(t);\n  while (t--) q();\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/361\"\n//\n#include \"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-0361.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-0361.test.cpp
- /verify/verify/verify-yuki/yuki-0361.test.cpp.html
