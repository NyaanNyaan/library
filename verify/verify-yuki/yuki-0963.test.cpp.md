...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-0963.test.cpp\"\n#define PROBLEM\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yuki/yuki-0963.test.cpp\"\
    ...
    \ { return mod; }\n};\n#line 8 \"verify/verify-yuki/yuki-0963.test.cpp\"\n\nusing\
    \ mint = LazyMontgomeryModInt<1012924417>;\nusing vm = vector<mint>;\nusing fps\
    \ = FormalPowerSeries<mint>;\n\nusing namespace Nyaan; void Nyaan::solve() {\n\
    \  ini(N);\n  auto g = [](const fps &f, int deg) {\n    return ((f * f + 1) *\
    \ mint(2).inverse()).pre(deg);\n  };\n  auto gp = [](const fps &f, int deg) {\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/963\"\n\n#include \"../../template/template.hpp\"\
    ...
    \ [](const fps &f, int deg) { return f.pre(deg); };\n  auto f = DifferentialEquation<mint>(g,\
    \ gp, 1, N + 1);\n  rep1(i, N) f[N] *= i;\n  out(f[N] * 2);\n}"
  dependsOn:
  - template/template.hpp
  - template/util.hpp
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-0963.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-0963.test.cpp
- /verify/verify/verify-yuki/yuki-0963.test.cpp.html
