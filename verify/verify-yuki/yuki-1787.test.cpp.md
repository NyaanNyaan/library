...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1787
    links:
    - https://yukicoder.me/problems/no/1787
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1787.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-yuki/yuki-1787.test.cpp\"\n//\n#line 2 \"tree/dynamic-rerooting.hpp\"\
    ...
    \ rake, add_edge,\n                            add_vertex>;\n*/\n#line 6 \"verify/verify-yuki/yuki-1787.test.cpp\"\
    ...
    \ > c.val) {\n      r.idx = p.idx;\n      r.all = false;\n    } else {\n     \
    \ r.idx = c.idx;\n      r.all = c.all;\n    }\n  } else {\n    r.idx = p.idx;\n\
    \    r.all = false;\n  }\n  return r;\n}\nPoint rake(const Point &a, const Point\
    \ &b) { return a.val > b.val ? a : b; }\nPoint add_edge(const Path &a) { return\
    \ {a.val, a.idx}; }\nPath add_vertex(const Point &a, const Info &i) {\n  return\
    \ {i.val, a.idx, true, a.val};\n}\nusing DR = DynamicRerooting<Path, Point, Info,\
    \ vertex, compress, rake, add_edge,\n                            add_vertex>;\n\
    \nvoid q() {\n  ini(N);\n  V<Info> init(N);\n  rep(i, N) init[i].idx = init[i].val\
    \ = i;\n  DR dr(N, init);\n  rep(i, N - 1) {\n    ini(a, b);\n    --a, --b;\n\
    \    dr.add_edge(a, b);\n  }\n  ini(Q);\n  int x = 0;\n  rep(_, Q) {\n    ini(u,\
    \ v);\n    u = (u + N - 1 + x) % N;\n    v = (v + N - 1 + x) % N;\n    auto uinfo\
    ...
    \    out(x = p.idx + 1);\n  }\n}\n\nvoid Nyaan::solve() {\n  int t = 1;\n  //\
    \ in(t);\n  while (t--) q();\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1787\"\n//\n#include \"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-1787.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1787.test.cpp
- /verify/verify/verify-yuki/yuki-1787.test.cpp.html
