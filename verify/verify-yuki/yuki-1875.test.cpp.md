...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1875.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-yuki/yuki-1875.test.cpp\"\n//\n#line 2 \"fps/composite-exp.hpp\"\
    ...
    \ * @brief $f(exp(cx))$ \u306E\u8A08\u7B97\n */\n#line 6 \"verify/verify-yuki/yuki-1875.test.cpp\"\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 10 \"verify/verify-yuki/yuki-1875.test.cpp\"\
    ...
    \ 13 \"verify/verify-yuki/yuki-1875.test.cpp\"\n// #include \"fps/arbitrary-fps.hpp\"\
    \n//\nusing namespace Nyaan;\nusing mint = LazyMontgomeryModInt<998244353>;\n\
    // using mint = LazyMontgomeryModInt<1000000007>;\nusing vm = vector<mint>;\n\
    using vvm = vector<vm>;\nBinomial<mint> C;\nusing fps = FormalPowerSeries<mint>;\n\
    using frac = fps_fraction<fps>;\nusing namespace Nyaan;\n\nvoid q() {\n  inl(N,\
    \ M);\n  vl a(N), b(N), c(N);\n  in3(a, b, c);\n  V<frac> fs;\n  rep(i, N) {\n\
    \    mint t = mint{a[i]}.inverse() * b[i];\n    fs.emplace_back(fps{t * c[i]},\
    \ fps{1, t});\n  }\n  while (sz(fs) > 1) {\n    V<frac> nx;\n    for (int i =\
    \ 0; i + 1 < sz(fs); i += 2) nx.push_back(fs[i] + fs[i + 1]);\n    if (sz(fs)\
    \ % 2) nx.push_back(fs.back());\n    fs = nx;\n  }\n  fps f = (fs[0].p * fs[0].q.inv(M\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-1875.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1875.test.cpp
- /verify/verify/verify-yuki/yuki-1875.test.cpp.html
