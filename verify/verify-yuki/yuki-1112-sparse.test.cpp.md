...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1112-sparse.test.cpp\"\n#define\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yuki/yuki-1112-sparse.test.cpp\"\
    ...
    \ Box Linear Algebra\n */\n#line 8 \"verify/verify-yuki/yuki-1112-sparse.test.cpp\"\
    ...
    \  vector<T> fac_, finv_, inv_;\n  Binomial(int MAX = 0) : fac_(MAX + 10), finv_(MAX\
    \ + 10), inv_(MAX + 10) {\n    assert(T::get_mod() != 0);\n    MAX += 9;\n   \
...
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1112-sparse.test.cpp
- /verify/verify/verify-yuki/yuki-1112-sparse.test.cpp.html
