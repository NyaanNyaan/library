...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-0125.test.cpp\"\n#define PROBLEM\
    ...
    \ - 1, r);\n  }\n};\n#line 8 \"verify/verify-yuki/yuki-0125.test.cpp\"\nBinomial<mint>\
    ...
    \ 11 \"verify/verify-yuki/yuki-0125.test.cpp\"\n//\n#line 2 \"template/template.hpp\"\
    \nusing namespace std;\n\n// intrinstic\n#include <immintrin.h>\n\n// bits\n#line\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 13 \"verify/verify-yuki/yuki-0125.test.cpp\"\
    \n\nusing namespace Nyaan;\n\nvoid Nyaan::solve() {\n  ini(K);\n  vi c(K);\n \
    \ in(c);\n  int S = accumulate(all(c), 0LL);\n\n  vi ds;\n  repc(i, 1, i * i <=\
    \ S) {\n    if (S % i == 0) {\n      ds.push_back(i);\n      if (i * i != S) ds.push_back(S\
    \ / i);\n    }\n  }\n  sort(all(ds));\n\n  int g = 0;\n  each(cc, c) g = __gcd(g,\
    \ cc);\n\n  mint ans1, ans2;\n  {\n    vm a(S + 1);\n    each(d, ds) {\n     \
    \ int sd = S / d;\n      if (g % sd != 0) {\n        a[d] = 0;\n        continue;\n\
