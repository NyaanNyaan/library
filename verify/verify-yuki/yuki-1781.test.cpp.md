...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1781.test.cpp\"\n#define PROBLEM\
    ...
    \ Nyaan {\nvoid solve();\n}\nint main() { Nyaan::solve(); }\n#line 4 \"verify/verify-yuki/yuki-1781.test.cpp\"\
    ...
    \  return ret;\n}\n#line 6 \"verify/verify-yuki/yuki-1781.test.cpp\"\n\nusing\
    ...
    \ */\n#line 12 \"verify/verify-yuki/yuki-1781.test.cpp\"\n//\nusing namespace\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1781\"\n//\n#include \"\
    ...
    \ ll c) { return cmemo[c + 1]; }\nvoid Nyaan::solve() {\n  inl(N, M);\n  rep(i,\
    \ 50) cmemo[i] = mint{i}.pow(N);\n  mf_prefix_sum<mint, f> mf(M);\n  auto pi =\
    \ mf.pi_table();\n  mint coe = mint{2}.pow(N);\n  each(x, pi) x *= coe;\n  out(mf.run(pi));\n\
    }\n"
  dependsOn:
  - template/template.hpp
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-1781.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1781.test.cpp
- /verify/verify/verify-yuki/yuki-1781.test.cpp.html
