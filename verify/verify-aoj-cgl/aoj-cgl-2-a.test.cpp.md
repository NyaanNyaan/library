...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-aoj-cgl/aoj-cgl-2-a.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_A\"\n//\n\
    ...
    \ 4 \"verify/verify-aoj-cgl/aoj-cgl-2-a.test.cpp\"\n//\n#line 2 \"geometry/line.hpp\"\
    ...
    \  return ret;\n}\n#line 6 \"verify/verify-aoj-cgl/aoj-cgl-2-a.test.cpp\"\nusing\
    \ namespace Nyaan;\n\nvoid q() {\n  ini(Q);\n  while (Q--) {\n    Point p0, p1,\
  ...
  verifiedWith: []
documentation_of: verify/verify-aoj-cgl/aoj-cgl-2-a.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-aoj-cgl/aoj-cgl-2-a.test.cpp
- /verify/verify/verify-aoj-cgl/aoj-cgl-2-a.test.cpp.html
