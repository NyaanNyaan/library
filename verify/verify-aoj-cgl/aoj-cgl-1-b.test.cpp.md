...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-aoj-cgl/aoj-cgl-1-b.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_B\"\n#define\
    ...
    \ 5 \"verify/verify-aoj-cgl/aoj-cgl-1-b.test.cpp\"\n//\n#line 2 \"geometry/line.hpp\"\
    ...
    \  return ret;\n}\n#line 7 \"verify/verify-aoj-cgl/aoj-cgl-1-b.test.cpp\"\nusing\
    \ namespace Nyaan;\n\nvoid q() {\n  Point p1, p2;\n  cin >> p1 >> p2;\n\n  Line\
    \ l{p1, p2};\n  ini(Q);\n  while (Q--) {\n    Point p;\n    in(p);\n    out(projection(l,\
    \ p) * 2 - p);\n  }\n}\n\nvoid Nyaan::solve() {\n  int t = 1;\n  // in(t);\n \
    \ while (t--) q();\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/verify-aoj-cgl/aoj-cgl-1-b.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-aoj-cgl/aoj-cgl-1-b.test.cpp
- /verify/verify/verify-aoj-cgl/aoj-cgl-1-b.test.cpp.html
