...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-fps/yosupo-polynomial-root-finding.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-fps/yosupo-polynomial-root-finding.test.cpp\"\n//\n\
    ...
    \ 6 \"verify/verify-yosupo-fps/yosupo-polynomial-root-finding.test.cpp\"\n//\n\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 10 \"verify/verify-yosupo-fps/yosupo-polynomial-root-finding.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/verify-yosupo-fps/yosupo-polynomial-root-finding.test.cpp
- /verify/verify/verify-yosupo-fps/yosupo-polynomial-root-finding.test.cpp.html
