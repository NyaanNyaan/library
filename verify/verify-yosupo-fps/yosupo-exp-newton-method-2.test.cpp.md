...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-fps/yosupo-exp-newton-method-2.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-fps/yosupo-exp-newton-method-2.test.cpp\"\n//\n#line\
    ...
    \ f = newton_method(calc_g, f0, (deg + 1) / 2);\n  int extra = 10, offset = 0;\n\
    ...
    \u30E5\u30FC\u30C8\u30F3\u6CD5\n */\n#line 6 \"verify/verify-yosupo-fps/yosupo-exp-newton-method-2.test.cpp\"\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 10 \"verify/verify-yosupo-fps/yosupo-exp-newton-method-2.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-fps/yosupo-exp-newton-method-2.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-fps/yosupo-exp-newton-method-2.test.cpp
- /verify/verify/verify-yosupo-fps/yosupo-exp-newton-method-2.test.cpp.html
