...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-fps/yosupo-inv-ofps.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/inv_of_formal_power_series\"\n//\n\
    ...
    \ 4 \"verify/verify-yosupo-fps/yosupo-inv-ofps.test.cpp\"\n//\n#line 2 \"fps/online-fps.hpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-fps/yosupo-inv-ofps.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-fps/yosupo-inv-ofps.test.cpp
- /verify/verify/verify-yosupo-fps/yosupo-inv-ofps.test.cpp.html
