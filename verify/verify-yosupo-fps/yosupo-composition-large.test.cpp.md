...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-fps/yosupo-composition-large.test.cpp\"\
    ...
    \ 4 \"verify/verify-yosupo-fps/yosupo-composition-large.test.cpp\"\n//\n#line\
    ...
    \ { return mod; }\n};\n#line 9 \"verify/verify-yosupo-fps/yosupo-composition-large.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yosupo-fps/yosupo-composition-large.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yosupo-fps/yosupo-composition-large.test.cpp
- /verify/verify/verify-yosupo-fps/yosupo-composition-large.test.cpp.html
