...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-aoj-grl/aoj-grl-3-b.test.cpp\"\n#define PROBLEM\
    \ \\\n  \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_3_B\"\n\
    ...
    };\n#line 6 \"verify/verify-aoj-grl/aoj-grl-3-b.test.cpp\"\n\nusing namespace\
    \ Nyaan; void Nyaan::solve() {\n  ini(N, E);\n  auto g = graph(N, E, false, false);\n\
    \  LowLink<vvi> lowlink(g);\n  each(p, lowlink.bridge) if (p.first > p.second)\
    \ swap(p.first, p.second);\n  sort(all(lowlink.bridge));\n  each(p, lowlink.bridge)\
    \ out(p);\n}\n"
  code: "#define PROBLEM \\\n  \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_3_B\"\
    \n\n#include \"../../template/template.hpp\"\n#include \"../../graph/lowlink.hpp\"\
    \n\nusing namespace Nyaan; void Nyaan::solve() {\n  ini(N, E);\n  auto g = graph(N,\
    \ E, false, false);\n  LowLink<vvi> lowlink(g);\n  each(p, lowlink.bridge) if\
    \ (p.first > p.second) swap(p.first, p.second);\n  sort(all(lowlink.bridge));\n\
...
layout: document
redirect_from:
- /verify/verify/verify-aoj-grl/aoj-grl-3-b.test.cpp
- /verify/verify/verify-aoj-grl/aoj-grl-3-b.test.cpp.html
