...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-aoj-grl/aoj-grl-4-a.test.cpp\"\n#define PROBLEM\
    \ \\\n  \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_4_A\"\n\
    ...
    \  return v;\n}\n#line 6 \"verify/verify-aoj-grl/aoj-grl-4-a.test.cpp\"\n\nvoid\
    \ solve() {\n  ini(N, M);\n  auto g = graph(N, M, true, false);\n  auto topo =\
    \ TopologicalSort<vvi>(g);\n  out(topo.size() == 0);\n}\n"
  code: "#define PROBLEM \\\n  \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_4_A\"\
    \n\n#include \"../../competitive-template.hpp\"\n#include \"../../graph/topological-sort.hpp\"\
    \n\nvoid solve() {\n  ini(N, M);\n  auto g = graph(N, M, true, false);\n  auto\
    \ topo = TopologicalSort<vvi>(g);\n  out(topo.size() == 0);\n}"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: verify/verify-aoj-grl/aoj-grl-4-a.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-aoj-grl/aoj-grl-4-a.test.cpp
- /verify/verify/verify-aoj-grl/aoj-grl-4-a.test.cpp.html
